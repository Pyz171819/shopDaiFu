...
<!--          <el-table-column label="用户编号" align="center" key="userId" prop="userId" v-if="columns.userId.visible" />-->
          ...
          <el-table-column label="用户类型" align="center" key="userType" prop="userType" v-if="columns.nickName.visible" :show-overflow-tooltip="true" >
            <template slot-scope="scope">
              <el-tag v-if="scope.row.userType === '00'" type="success">后端用户</el-tag>
              <el-tag v-if="scope.row.userType === '01'" type="danger">前端用户</el-tag>
            </template>
          </el-table-column>>
          <el-table-column label="用户头像" align="center" key="avatar" prop="avatar" v-if="columns.nickName.visible" :show-overflow-tooltip="true" >
            <template slot-scope="scope">
              <image-preview :src="scope.row.avatar" :width="50" :height="50"/>
            </template>
          </el-table-column>>

          <el-table-column label="发布商品权限" align="center" key="permAddProduct" prop="permAddProduct" v-if="columns.nickName.visible" :show-overflow-tooltip="true" >
            <template slot-scope="scope">
              <el-tag v-if="scope.row.bizUser.permAddProduct === '0'" type="danger">不可上架</el-tag>
          ...
          >
            <template slot-scope="scope">
              <div style="line-height: 30px; text-align: center; font-weight: 500;">
                <div style="color: #2e8b57; font-size: 16px;">
          ...
          <el-table-column label="登录IP" align="center" key="loginIp" prop="loginIp" v-if="columns.nickName.visible" :show-overflow-tooltip="true" />
          ...
          <el-col :span="12">
            <el-form-item label="用户类型" prop="userType">
              <el-select v-model="form.userType" >
                <el-option label="后端用户" value="00" />
                <el-option label="前端用户" value="01" />
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="上架权限" prop="bizUser.permAddProduct">
              <el-select v-model="form.bizUser.permAddProduct" >
                <el-option label="不可上架" value="0" />
                <el-option label="可上架" value="1" />
              </el-select>
            </el-form-item>
          </el-col>
        </el-row>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除用户"' + row.nickName + '"的数据项？').then(function() {
